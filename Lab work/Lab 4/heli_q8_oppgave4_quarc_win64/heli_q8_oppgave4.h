...
#ifndef RTW_HEADER_heli_q8_oppgave4_h_
#define RTW_HEADER_heli_q8_oppgave4_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_oppgave4_COMMON_INCLUDES_
#define heli_q8_oppgave4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_oppgave4_COMMON_INCLUDES_ */

#include "heli_q8_oppgave4_types.h"
...
#define heli_q8_oppgave4_rtModel       RT_MODEL_heli_q8_oppgave4_T

/* Block signals (default storage) */
typedef struct {
  real_T PitchCounttorad;              /* '<S4>/Pitch: Count to rad' */
  real_T DataTypeConversion2[3];       /* '<S5>/Data Type Conversion2' */
  real_T Gain1[3];                     /* '<S5>/Gain1' */
  real_T DataTypeConversion1[3];       /* '<S5>/Data Type Conversion1' */
  ...
  real_T UnitDelay[6];                 /* '<S6>/Unit Delay' */
  real_T UnitDelay1[36];               /* '<S6>/Unit Delay1' */
  real_T RateTransitionx;              /* '<S21>/Rate Transition: x' */
  real_T Joystick_gain_x;              /* '<S21>/Joystick_gain_x' */
  real_T Switch;                       /* '<S8>/Switch' */
  real_T RateTransitiony;              /* '<S21>/Rate Transition: y' */
  real_T Joystick_gain_y;              /* '<S21>/Joystick_gain_y' */
  ...
  real_T x_kf_pred[6];                 /* '<S6>/Kalman_predictor' */
  real_T P_kf_pred[36];                /* '<S6>/Kalman_predictor' */
  real_T x_kf_est[6];                  /* '<S6>/Kalman_estimation' */
  real_T P_kf_est[36];                 /* '<S6>/Kalman_estimation' */
  real_T euler_rates[3];
         /* '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  real_T euler_angles[2];
         /* '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  real32_T StreamFormattedRead1_o2;    /* '<S5>/Stream Formatted Read1' */
  real32_T StreamFormattedRead1_o3;    /* '<S5>/Stream Formatted Read1' */
  real32_T StreamFormattedRead1_o4;    /* '<S5>/Stream Formatted Read1' */
  real32_T StreamFormattedRead1_o5;    /* '<S5>/Stream Formatted Read1' */
  real32_T StreamFormattedRead1_o6;    /* '<S5>/Stream Formatted Read1' */
  real32_T StreamFormattedRead1_o7;    /* '<S5>/Stream Formatted Read1' */
  real32_T UnitDelay_c;                /* '<S11>/Unit Delay' */
  real32_T UnitDelay_d;                /* '<S12>/Unit Delay' */
  real32_T UnitDelay_n;                /* '<S13>/Unit Delay' */
  real32_T UnitDelay_i;                /* '<S14>/Unit Delay' */
  real32_T UnitDelay_c0;               /* '<S15>/Unit Delay' */
  real32_T UnitDelay_a;                /* '<S16>/Unit Delay' */
  uint8_T StreamCall2_o2;              /* '<S5>/Stream Call2' */
  boolean_T StreamFormattedRead1_o10;  /* '<S5>/Stream Formatted Read1' */
  boolean_T StreamFormattedRead1_o11;  /* '<S5>/Stream Formatted Read1' */
...
typedef struct {
  ...
  real_T RateTransitionx_Buffer0;      /* '<S21>/Rate Transition: x' */
  real_T RateTransitiony_Buffer0;      /* '<S21>/Rate Transition: y' */
  real_T HILWriteAnalog_Buffer[2];     /* '<S4>/HIL Write Analog' */
  t_stream StreamCall2_Stream;         /* '<S5>/Stream Call2' */
  t_game_controller GameController_Controller;/* '<S21>/Game Controller' */
  ...
  struct {
    void *LoggedData[6];
  } Estimatvsencoder1_PWORK;           /* '<Root>/Estimat vs encoder1' */
  ...
  struct {
    void *LoggedData;
  } Closed_PWORK;                      /* '<S5>/Closed' */

  struct {
    void *LoggedData;
  } Connected2_PWORK;                  /* '<S5>/Connected2' */
  ...
  struct {
    void *LoggedData;
  } XScope_PWORK;                      /* '<S21>/X: Scope' */

  struct {
    void *LoggedData;
  } YScope_PWORK;                      /* '<S21>/Y: Scope' */

  struct {
    void *LoggedData;
  } Scope_PWORK_p;                     /* '<S10>/Scope' */
  ...
  real32_T UnitDelay_DSTATE_dd;        /* '<S16>/Unit Delay' */
  ...
  int8_T Skiptonextline_SubsysRanBC;   /* '<S5>/Skip to next line' */
  uint8_T StreamCall2_State;           /* '<S5>/Stream Call2' */
} DW_heli_q8_oppgave4_T;
...
#define rtB                            heli_q8_oppgave4_B
#define BlockIO                        B_heli_q8_oppgave4_T
#define rtX                            heli_q8_oppgave4_X
#define ContinuousStates               X_heli_q8_oppgave4_T
#define rtXdot                         heli_q8_oppgave4_XDot
#define StateDerivatives               XDot_heli_q8_oppgave4_T
#define tXdis                          heli_q8_oppgave4_XDis
#define StateDisabled                  XDis_heli_q8_oppgave4_T
#define rtP                            heli_q8_oppgave4_P
#define Parameters                     P_heli_q8_oppgave4_T
#define rtDWork                        heli_q8_oppgave4_DW
#define D_Work                         DW_heli_q8_oppgave4_T

/* Parameters (default storage) */
struct P_heli_q8_oppgave4_T_ {
  ...
  real_T Joystick_gain_x;              /* Variable: Joystick_gain_x
                                        * Referenced by: '<S21>/Joystick_gain_x'
                                        */
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        * Referenced by: '<S21>/Joystick_gain_y'
                                        */
  real_T K_aug[10];                    /* Variable: K_aug
                                        ...
                                        *   '<S9>/K1'
                                        */
  real_T P_init_pred[36];              /* Variable: P_init_pred
  ...
  real_T Vs_0;                         /* Variable: Vs_0
                                        ...
                                        */
  real_T X_init_pred[6];               /* Variable: X_init_pred
  ...
  uint16_T GameController_BufferSize;
                                 ...
                                 * Referenced by: '<S21>/Game Controller'
                                 */
...
struct tag_RTM_heli_q8_oppgave4_T {
  const char_T *path;
...
extern P_heli_q8_oppgave4_T heli_q8_oppgave4_P;

/* Block signals (default storage) */
extern B_heli_q8_oppgave4_T heli_q8_oppgave4_B;

/* Continuous states (default storage) */
extern X_heli_q8_oppgave4_T heli_q8_oppgave4_X;

/* Block states (default storage) */
extern DW_heli_q8_oppgave4_T heli_q8_oppgave4_DW;
...
extern void heli_q8_oppgave4_initialize(void);
extern void heli_q8_oppgave4_output0(void);
extern void heli_q8_oppgave4_update0(void);
extern void heli_q8_oppgave4_output(int_T tid);
extern void heli_q8_oppgave4_update(int_T tid);
extern void heli_q8_oppgave4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_oppgave4_rtModel *heli_q8_oppgave4(void);
...
extern RT_MODEL_heli_q8_oppgave4_T *const heli_q8_oppgave4_M;
 ...
 *
 * '<Root>' : 'heli_q8_oppgave4'
 * '<S1>'   : 'heli_q8_oppgave4/Conversion'
 * '<S2>'   : 'heli_q8_oppgave4/Data logging'
 * '<S3>'   : 'heli_q8_oppgave4/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S4>'   : 'heli_q8_oppgave4/Heli 3D'
 * '<S5>'   : 'heli_q8_oppgave4/IMU_BT'
 * '<S6>'   : 'heli_q8_oppgave4/Kalman filter'
 * '<S7>'   : 'heli_q8_oppgave4/LQR controller with integral action'
 * '<S8>'   : 'heli_q8_oppgave4/Reference1'
 * '<S9>'   : 'heli_q8_oppgave4/Subsystem'
 * '<S10>'  : 'heli_q8_oppgave4/Vs_0'
 * '<S11>'  : 'heli_q8_oppgave4/IMU_BT/Check if equal'
 * '<S12>'  : 'heli_q8_oppgave4/IMU_BT/Check if equal1'
 * '<S13>'  : 'heli_q8_oppgave4/IMU_BT/Check if equal2'
 * '<S14>'  : 'heli_q8_oppgave4/IMU_BT/Check if equal3'
 * '<S15>'  : 'heli_q8_oppgave4/IMU_BT/Check if equal4'
 * '<S16>'  : 'heli_q8_oppgave4/IMU_BT/Check if equal5'
 * '<S17>'  : 'heli_q8_oppgave4/IMU_BT/Skip to next line'
 * '<S18>'  : 'heli_q8_oppgave4/Kalman filter/Kalman_estimation'
 * '<S19>'  : 'heli_q8_oppgave4/Kalman filter/Kalman_predictor'
 * '<S20>'  : 'heli_q8_oppgave4/Kalman filter/Make y'
 * '<S21>'  : 'heli_q8_oppgave4/Reference1/Joystick'
 */
#endif                                 /* RTW_HEADER_heli_q8_oppgave4_h_ */
