 ...
 * C source code generated on : Tue Aug 31 13:45:09 2021
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step_Time) {
    /* Step: '<Root>/Step' */
    heli_q8_B.Setpoint = heli_q8_P.Step_Y0;
  } else {
    /* Step: '<Root>/Step' */
    heli_q8_B.Setpoint = heli_q8_P.Step_YFinal;
  }
   ...
   *  Sum: '<S5>/Sum'
   */
  heli_q8_B.Sum1 = (heli_q8_B.Setpoint - heli_q8_B.PitchCounttorad) *
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Gain: '<Root>/Gain1'
     */
    rtb_DeadZonex = heli_q8_P.Gain1_Gain * heli_q8_B.Joystick_gain_y;

    /* Sum: '<S2>/Sum' incorporates:
     *  Constant: '<Root>/Constant'
     *  Sum: '<Root>/Sum'
     */
    rtb_Sum_k = rtb_DeadZonex - (heli_q8_B.ElevationCounttorad -
   ...
   *  Sum: '<S1>/Add'
   */
  heli_q8_B.Frontgain = (heli_q8_B.Add - heli_q8_B.Sum1) *
    heli_q8_P.Frontgain_Gain;

  /* Gain: '<S1>/Back gain' incorporates:
   *  Sum: '<S1>/Subtract'
   */
  heli_q8_B.Backgain = (heli_q8_B.Add + heli_q8_B.Sum1) *
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_B.Sum1;
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_B.Add;
    rtb_TmpSignalConversionAtToFile[8] = rtb_DeadZonex;
    rtb_TmpSignalConversionAtToFile[9] = heli_q8_B.Setpoint;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3465864490U);
  heli_q8_M->Sizes.checksums[1] = (2236371574U);
  heli_q8_M->Sizes.checksums[2] = (927256618U);
  heli_q8_M->Sizes.checksums[3] = (127733326U);
