 ...
 * C source code generated on : Tue Sep 21 12:14:12 2021
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* SignalConversion generated from: '<Root>/F' incorporates:
     *  Gain: '<Root>/Gain'
     */
    rtb_r_idx_0 = heli_q8_B.Joystick_gain_x;
    rtb_r_idx_1 = heli_q8_P.Gain_Gain * heli_q8_B.Joystick_gain_y;
    ...
    heli_q8_B.F[0] += heli_q8_P.F[2] * rtb_r_idx_1;
    heli_q8_B.F[1] = 0.0;
    heli_q8_B.F[1] += heli_q8_P.F[1] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.F[1] += heli_q8_P.F[3] * rtb_r_idx_1;
  }
  ...
  for (iy = 0; iy < 2; iy++) {
     ...
     */
    heli_q8_B.u[iy] = heli_q8_B.F[iy] - ((heli_q8_P.K[iy + 2] *
      heli_q8_B.PitchTransferFcn + heli_q8_P.K[iy] * heli_q8_B.PitchCounttorad)
      + heli_q8_P.K[iy + 4] * heli_q8_B.ElevationTransferFcn);
  }

  /* Sum: '<Root>/Sum1' incorporates:
   *  Constant: '<Root>/Constant'
   */
  heli_q8_B.Sum1 = heli_q8_B.u[0] + heli_q8_P.Vs_0;

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  heli_q8_B.Frontgain = (heli_q8_B.Sum1 - heli_q8_B.u[1]) *
    heli_q8_P.Frontgain_Gain;

  /* Gain: '<S1>/Back gain' incorporates:
   *  Sum: '<S1>/Subtract'
   */
  heli_q8_B.Backgain = (heli_q8_B.Sum1 + heli_q8_B.u[1]) *
  ...
  for (iy = 0; iy < 3; iy++) {
    rtb_StateSpace[iy] = heli_q8_P.StateSpace_C[iy + 6] *
      heli_q8_X.StateSpace_CSTATE[2] + (heli_q8_P.StateSpace_C[iy + 3] *
      heli_q8_X.StateSpace_CSTATE[1] + heli_q8_P.StateSpace_C[iy] *
      heli_q8_X.StateSpace_CSTATE[0]);
  }
  ...
  for (iy = 0; iy < 2; iy++) {
    ...
    heli_q8_B.Gain1[iy] += heli_q8_P.C[iy] * rtb_StateSpace[0];
    heli_q8_B.Gain1[iy] += heli_q8_P.C[iy + 2] * rtb_StateSpace[1];
    heli_q8_B.Gain1[iy] += heli_q8_P.C[iy + 4] * rtb_StateSpace[2];
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.ElevationCounttorad;
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_B.ElevationTransferFcn;
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_B.u[1];
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_B.Sum1;
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_B.Joystick_gain_y;
    rtb_TmpSignalConversionAtToFile[9] = heli_q8_B.Joystick_gain_x;
    rtb_TmpSignalConversionAtToFile[10] = heli_q8_B.Frontgain;
    rtb_TmpSignalConversionAtToFile[11] = heli_q8_B.Backgain;
      ...
      if (rtmIsMajorTimeStep(heli_q8_M) ) {
        {
          if (!(++heli_q8_DW.ToFile_IWORK.Decimation % 1) &&
              (heli_q8_DW.ToFile_IWORK.Count * (12 + 1)) + 1 < 100000000 ) {
            ...
            if (fp != (NULL)) {
              ...
              if (((++heli_q8_DW.ToFile_IWORK.Count) * (12 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
    ...
    /* Gain: '<Root>/F1' */
    heli_q8_B.F1[0] = 0.0;
    heli_q8_B.F1[0] += heli_q8_P.F[0] * rtb_r_idx_0;
    heli_q8_B.F1[0] += heli_q8_P.F[2] * rtb_r_idx_1;
    heli_q8_B.F1[1] = 0.0;
    heli_q8_B.F1[1] += heli_q8_P.F[1] * rtb_r_idx_0;
    heli_q8_B.F1[1] += heli_q8_P.F[3] * rtb_r_idx_1;
  }
  ...
  for (iy = 0; iy < 2; iy++) {
     ...
     *  Gain: '<Root>/K1'
     */
    heli_q8_B.u_e[iy] = heli_q8_B.F1[iy] - ((heli_q8_P.K[iy + 2] *
      rtb_StateSpace[1] + heli_q8_P.K[iy] * rtb_StateSpace[0]) + heli_q8_P.K[iy
      + 4] * rtb_StateSpace[2]);
  }
}
...
void heli_q8_derivatives(void)
{
  ...
  for (ri = 0; ri < 3; ri++) {
    _rtXdot->StateSpace_CSTATE[ri] += heli_q8_P.A[ri] *
      heli_q8_X.StateSpace_CSTATE[0];
    _rtXdot->StateSpace_CSTATE[ri] += heli_q8_P.A[ri + 3] *
      heli_q8_X.StateSpace_CSTATE[1];
    _rtXdot->StateSpace_CSTATE[ri] += heli_q8_P.A[ri + 6] *
      heli_q8_X.StateSpace_CSTATE[2];
    _rtXdot->StateSpace_CSTATE[ri] += heli_q8_P.B[ri] * heli_q8_B.u_e[0];
    _rtXdot->StateSpace_CSTATE[ri] += heli_q8_P.B[ri + 3] * heli_q8_B.u_e[1];
  }
...
void heli_q8_initialize(void)
{
  ...
  heli_q8_X.StateSpace_CSTATE[0] = heli_q8_P.StateSpace_InitialCondition;
  heli_q8_X.StateSpace_CSTATE[1] = heli_q8_P.StateSpace_InitialCondition;
  heli_q8_X.StateSpace_CSTATE[2] = heli_q8_P.StateSpace_InitialCondition;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4242930795U);
  heli_q8_M->Sizes.checksums[1] = (1611327129U);
  heli_q8_M->Sizes.checksums[2] = (919191020U);
  heli_q8_M->Sizes.checksums[3] = (4212661233U);
