  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(53).dtTransOffset = 92;
	  ...
	  section.data(66).dtTransOffset = 105;
	  ...
	  section.data(68).dtTransOffset = 107;
	  ...
	  section.data(71).dtTransOffset = 110;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_oppgave3_B.TransferFcn
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% heli_q8_oppgave3_B.StreamFormattedRead1_o8
	  section.data(1).logicalSrcIdx = 41;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_oppgave3_B.StreamFormattedRead1_o9
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_oppgave3_DW.Scope4_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.Invalid_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.Scope2_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.Scope4_PWORK_c.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 21;
	
	  ;% heli_q8_oppgave3_DW.Scope5_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 27;
	  section.data(13).dtTransOffset = 22;
	
	  ;% heli_q8_oppgave3_DW.Scope6_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.ax1_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.ay1_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.az1_PWORK.LoggedData
	  section.data(20).logicalSrcIdx = 34;
	  section.data(20).dtTransOffset = 29;
	
	  ;% heli_q8_oppgave3_DW.fields_PWORK.LoggedData
	  section.data(21).logicalSrcIdx = 35;
	  section.data(21).dtTransOffset = 30;
	
	  ;% heli_q8_oppgave3_DW.units_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.wx1_PWORK.LoggedData
	  ...
	  ;% heli_q8_oppgave3_DW.wy1_PWORK.LoggedData
  ...
  targMap.checksum0 = 3858695019;
  targMap.checksum1 = 2474585812;
  targMap.checksum2 = 1527850917;
  targMap.checksum3 = 3487426430;
